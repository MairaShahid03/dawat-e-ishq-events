      ...
      <section className="section-padding bg-noir">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Trending Events */}
            <div>
              <h3 className="flex items-center gap-2 text-ivory mb-4">
                ...
                {trendingEvents.map((event, i) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="p-4 border border-gold/10 rounded-xl bg-noir/30"
                    >
                      <div className="flex justify-between">
                        <p className="text-ivory text-sm">{event.name}</p>
                        <span className="text-green-400 text-xs">{event.trend}</span>
                      </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                {popularPackages.map((pkg, i) => (
                  ...
                  >
                    <div className="flex justify-between">
                      <p className="text-ivory text-sm">{pkg.name}</p>
                      <span className="text-gold text-xs">{pkg.price}</span>
                    </div>

                    <div className="w-full h-1.5 bg-ivory/10 rounded-full mt-2 overflow-hidden">
                      <div
      ...
      <section className="section-padding bg-noir">
        <div className="container mx-auto text-center max-w-xl">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-gold uppercase mb-3">Get in Touch</p>

            <h2 className="text-ivory text-3xl mb-6">
              Contact Us
            </h2>
