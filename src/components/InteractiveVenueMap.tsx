...
const venues: Venue[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1519167758993-c1a1f5e5e8d0?w=400&h=300&fit=crop",
    rating: 4.8,
    amenities: ["AC Hall", "Parking", "Catering", "Decor"],
  ...
  },
  {
    ...
    rating: 4.7,
    amenities: ["Outdoor Garden", "Lighting", "Sound System", "Parking"],
  ...
  },
  {
    ...
    capacity: 400,
    priceRange: "PKR 400,000 - 1,200,000",
    image: "https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?w=400&h=300&fit=crop",
    rating: 4.9,
    amenities: ["Crystal Chandeliers", "Dance Floor", "VIP Lounge", "Catering"],
    coordinates: { lat: 24.9, lng: 67.1 },
  },
  {
    id: "4",
    name: "Beachfront Paradise",
    location: "Karachi, Hawkes Bay",
    capacity: 350,
    priceRange: "PKR 350,000 - 900,000",
    image: "https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?w=400&h=300&fit=crop",
    rating: 4.6,
    amenities: ["Beach Access", "Sea View", "Sunset Setup", "Parking"],
    coordinates: { lat: 24.7, lng: 67.0 },
  },
];
